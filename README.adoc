...
== Systemüberblick
Die folgende Abbildung gibt einen Überblick über die Systemarchitektur des TI-Messengers in der Version 1.1 und zeigt die in dieser Dokumentation beschriebenen Schnittstellen. 
