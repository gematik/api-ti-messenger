...
CAUTION: *Planned changes for TI-Messenger-Dienst version 1.1:* https://github.com/gematik/api-vzd/blob/develop/src/schema/FederationList.json[TI-Messenger v1.1 changes].
