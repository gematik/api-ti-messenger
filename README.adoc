...
link:docs/FHIR-Directory.adoc[*IDP-Dienst*] +
...
* *Authenticator:* +
Das Authenticator-Modul erhält vom IDP-Dienst einen `AUTHORIZATION_CODE` zurück, welches durch Vorlage vom Registrierungs-Dienst oder vom Auth-Service des VZD-FHIR-Directory am IDP-Dienst durch ein ID_TOKEN ausgetauscht wird.
