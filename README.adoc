...
== Systemüberblick
Die folgende Abbildung gibt einen Überblick über die Systemarchitektur des TI-Messengers in der Version 1.1. Schnittstellen die der Authentifizierung dienen werden in der Abbildung nicht berücksichtigt. 
