...
* die Echtzeit-Kommunikation zwischen Leistungserbringern und Leistungserinstitutionen und
* die Echtzeit-Kommunikation direkt zwischen Leistungserbringern.

_Hinweis: In der TI-Messenger Spezifikation v1.1 können keine Versicherten an den TI-Messenger Dienst teilnehmen_
