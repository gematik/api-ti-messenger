...
|*Dokument*|*Alt*|*Neu*
|Dienst 
|In Abbildung 20 wird bei einigen Aufrufen nach Erhalt des SearchAccessToken die MXID des Users verwendet. Diese wird für die Authentisierung nicht benötigt und die Rückgabe an den Client wird ein FHIR Bundle sein. 
