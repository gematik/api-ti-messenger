...
|gemSpec_TI-Messenger-Client
|Produktgutachten
|Das Prüfverfahren wird geändert in *Sicherheitsgutachten*. Es muss durch den Hersteller dokumentiert werden, wie und wo die Umsetzung erfolgt ist. Weiterhin muss Konformität im Rahmen von Tests einzelner Teilanforderungen nachgewiesen werden.
