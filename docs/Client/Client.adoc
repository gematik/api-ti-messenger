...
TIP: Die Seite ergänzt die Spezifikation gemäß link:https://fachportal.gematik.de/fachportal-import/files/gemSpec_TI-Messenger-Client_V1.1.1.pdf[&#91;gemSpec_TI-Messenger-Client&#93;], die als Grundlage für das Verständnis vorrausgesetzt wird. 
