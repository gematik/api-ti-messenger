...
[%collapsible%open]
====
image:plantuml/TI-Messenger-Dienst/Ressourcen/UC_Update_Federationlist_Seq.svg[width="100%"]
====
...
[%collapsible%open]
====
image:plantuml/TI-Messenger-Dienst/Ressourcen/UC_Update_Federationlist_auth_retrieve.svg[width="100%"]
====
...
[%collapsible%open]
====
image:plantuml/TI-Messenger-Dienst/Ressourcen/UC_Update_Federationlist_SignCheck.svg[align="center",width="60%"]
====
