...
++++
<img align="center" width="55%" src=../../images/drawio/TI-Messenger-Fachdienst/API-Messenger-Service.svg>
++++
...
++++
<p align="left">
  <img width="100%" src=../../images/drawio/TI-Messenger-Fachdienst/funktionalitaet_proxy.svg>
</p>
++++
