...
== Auth Modul
Über dieses abstrakten Modul wird die Kommunikation mit dem IDP durchgeführt. Der TI-Messenger-Client authentisiert sich mittels OpenID-Connect um ein ID_TOKEN ausgestellt zu bekommen. Für die Authentisierung am IDP wird endweder eine SMC-B oder ein HBA verwendet.
