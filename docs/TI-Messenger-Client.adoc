...
|HealthcareService | To search for organizations, use "HealthcareService" as the resource type
|PractitionerRole | To search for people, use "PractitionerRole" as the resource type
|===
