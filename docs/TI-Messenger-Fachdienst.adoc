...
=== Messenger-Proxy
Der Messenger-Proxy als Prüfinstanz aller eingehenden `Invite Events`???? zum Messenger-Service ist für die Regelung der gemäß Matrix Client-Server-API und Matrix-Server-Server-API geltenden Aufrufe zuständig.
