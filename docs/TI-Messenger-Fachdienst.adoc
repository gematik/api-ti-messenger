...
Für die Adminstration der Freigabeliste eines Akteurs wird durch den Messenger Proxy das Interface `I_TiMessengerContactManagement` bereitgestellt welches die Administration dieser Liste für jeden Akteur ermöglicht. Die Beschreibung der Schnittstelle ist hier beschrieben: https://github.com/gematik/api-ti-messenger/blob/feature/fachdienst/src/openapi/TiMessengerContactManagement.yaml[&#91;TIMessengerContactManagement&#93;]
