...
Dies betrifft die Anwendungsfälle für die Authntisierung mittels OpenID Connect oder über das KIM-Verfahren, wo mit Hilfe kryptograschis Schlüsselmaterial geprüft wird, ob eine KIM-EMail erfolgreich entschlüsselt werden kann. 
