...
*Beispiel: Authorization code: TODO*
...
Der *Relying Party* MUSS das erhaltene ID_TOKEN vor der Verwendung mit seinem korrespondierenden privaten Entschlüsselungskey entsprechend der "kid" in Header entschlüsseln. Signatur + Fachdienste MÜSSEN erhaltene ID_TOKEN auf das Vorhandensein der benötigten scopes überprüfen.
