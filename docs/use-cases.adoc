...
link:use-cases/authenticate-organization.adoc[Use Case & Sequence diagram]
...
link:use-cases/provision-messenger-service.adoc[Use Case & Sequence diagram]
...
link:use-cases/check-federation.adoc[Use Case & Sequence diagram]
